...
let tradElinvSpace = function () {
    ...
    function escritorio() {
        ...
        // ---------------------------------------------------    
        // MARK: obtener la selección simple o múltiple
        function obtieneSeleccion() {
            function ejecutado(result) {
                ...
                // para todas las formas de traducción posible
                    ...
                    var urlTRADUC = "https://translate.google.com/?elinv=traduc&hl=" + idiomaNavegador + "#" + codigoOrigenVar + "/" + codigoDestinoVar + "/" + result.toString();
        ...
        function traducirWebEntera() {
            ...
            var seleccion = `var res = window.location.href
        ...
        chrome.tabs.onUpdated.addListener(function (tabId, changeInfo, tab) {
            ...
            if (tab.url.indexOf('https://translate.google.com/?elinv=traduc&') != -1 &&
                changeInfo.status == 'complete' && tradEnGoogle !== 3) {
        ...
        function mensajes(message) {
            ...
            if (tradEnGoogle === 2) {
                msj("../ico/verde.ico", 1);
                // traducimos
                var pagInglesEsp = 'http://translate.google.com/translate?elinv=traduc&sl=auto&tl=' +
                    codigoDestinoVar + '&u=' + encodeURIComponent(message.url);
                try {
                ...
                function onUpdatedMultitrad(tab) {
                    // MARK: MULTITRADUCCION reemplazo
        ...
        browser.commands.onCommand.addListener((command) => {
            ...
            //var seleccion = "window.getSelection().toString();";
            //            respuesta = document.getElementById("dialogElv").style.visibility;\
        ...
        function infoELINV(texto) {
            ...
            switch (tipoDeInform) {
                case "buscar_en_google":
                    ...
                    break;
                case "definicion_en_google":
                    urlElinv = "https://www.google.com/search?q=" + texto + "+significado&oq=" + texto + "+significado"
                    break;
                case "buscar_en_wikipedia":
                ...
                case "wordreference":
                    ...
                    break;
                case "que_significa":
                    urlElinv = "https://que-significa.com/significado.php?termino=" + texto
                    break;
            }
        ...
        function msj(httpIcon, mensaje) {
            if (mensaje == 1) {
                ...
                mensaje = idiomaOrigenVar + "(" + codigoOrigenVar + ") - " + idiomaDestinoVar + "(" + codigoDestinoVar + ")";
            }
